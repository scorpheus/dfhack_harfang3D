...
def create_iso_geo_from_block(id_block, id_block_up, array_world_big_block, ):
	...
	array_has_geo[:, 0, :] = array_world_big_block[id_block]["iso_array"]
	array_has_geo[:, 1, :] = array_world_big_block[id_block_up]["iso_array"]

	array_mats = np.empty((17, 2, 17), np.int8)
	array_mats[:, 0, :] = array_world_big_block[id_block]["iso_array_mat"]
	array_mats[:, 1, :] = array_world_big_block[id_block_up]["iso_array_mat"]
...
def update_iso_mesh(array_world_big_block, id_block, pos):
	...
	if up_id in array_world_big_block and array_world_big_block[up_id]["status"] == status_ready:
		array_world_big_block[id_block]["iso_mesh"] = create_iso_geo_from_block(id_block, up_id)
	...
	if down_id in array_world_big_block and array_world_big_block[down_id]["status"] == status_ready:
		array_world_big_block[down_id]["iso_mesh"] = create_iso_geo_from_block(down_id, id_block)
...
def make_big_block_iso(array_world_big_block, big_block):
	...
	if north_id in array_world_big_block and array_world_big_block[north_id]["status"] == status_ready:
		array_world_big_block[north_id]["iso_array"][:, -1] = array_world_big_block[id_block]["iso_array"][:, 0]
		array_world_big_block[north_id]["iso_array_mat"][:, -1] = array_world_big_block[id_block]["iso_array_mat"][:, 0]
	...
	if south_name in array_world_big_block and array_world_big_block[south_name]["status"] == status_ready:
		array_world_big_block[id_block]["iso_array"][:, -1] = array_world_big_block[south_name]["iso_array"][:, 0]
		array_world_big_block[id_block]["iso_array_mat"][:, -1] = array_world_big_block[south_name]["iso_array_mat"][:, 0]

	if west_name in array_world_big_block and array_world_big_block[west_name]["status"] == status_ready:
		array_world_big_block[west_name]["iso_array"][-1, :] = array_world_big_block[id_block]["iso_array"][0, :]
		array_world_big_block[west_name]["iso_array_mat"][-1, :] = array_world_big_block[id_block]["iso_array_mat"][0, :]
	...
	if east_name in array_world_big_block and array_world_big_block[east_name]["status"] == status_ready:
		array_world_big_block[id_block]["iso_array"][-1, :] = array_world_big_block[east_name]["iso_array"][0, :]
		array_world_big_block[id_block]["iso_array_mat"][-1, :] = array_world_big_block[east_name]["iso_array_mat"][0, :]
